 ...
 */
#ifndef RAINY_FOUNDATION_CONTAINER_IMPLEMENTS_ANY_EXECUTION_POLICY_HPP
#define RAINY_FOUNDATION_CONTAINER_IMPLEMENTS_ANY_EXECUTION_POLICY_HPP
...
namespace rainy::foundation::container::implements {
    ...
    struct convert_any_binding_package {
        static decltype(auto) impl(const any_binding_package &pkg) {
            if constexpr (type_traits::type_relations::is_same_v<TargetType, std::in_place_t>) {
                return std::in_place;
            } else {
                ...
                if constexpr (is_any_convert_invocable<TargetType>) {
                    if (utility::any_converter<TargetType>::is_convertible(*pkg.type)) {
                        return utility::any_converter<TargetType>::basic_convert(pkg.payload, *pkg.type);
                    }
                } else if constexpr (is_any_convert_invocable<type_traits::modifers::remove_cv<TargetType>>) {
                    if (utility::any_converter<type_traits::modifers::remove_cv_t<TargetType>>::is_convertible(*pkg.type)) {
                        return utility::any_converter<type_traits::modifers::remove_cv_t<TargetType>>::basic_convert(pkg.payload,
                                                                                                                     *pkg.type);
                    }
                } else if constexpr (is_any_convert_invocable<type_traits::modifers::remove_cvref_t<TargetType>>) {
                    if (utility::any_converter<type_traits::modifers::remove_cvref_t<TargetType>>::is_convertible(*pkg.type)) {
                        return utility::any_converter<type_traits::modifers::remove_cvref_t<TargetType>>::basic_convert(pkg.payload,
                                                                                                                        *pkg.type);
                    }
                }
                if (is_convertible_to(*pkg.type, rainy_typeid(TargetType))) {
                    return core::dynamic_convert<TargetType>(pkg.payload, *pkg.type);
                }
                std::terminate();
            }
        }
...
namespace rainy::foundation::container {
    template <typename Ty, typename Any, bool WithEqual = false>
    struct any_magic_method {
        using any = Any;

        static inline constexpr bool not_bool = !type_traits::type_relations::is_same_v<bool, type_traits::modifers::remove_cvref_t<Ty>>;

        any add(const any &left, const any &right) const {
            if constexpr (type_traits::extras::meta_method::has_operator_add_v<Ty> && not_bool) {
                return implements::any_magic_method_helper<any, Ty>(left, right, functional::plus{});
            }
            return {};
        }
        ...
        any subtract(const any &left, const any &right) const {
            if constexpr (type_traits::extras::meta_method::has_operator_sub_v<Ty> && not_bool) {
                return implements::any_magic_method_helper<any, Ty>(left, right, functional::minus<>{});
            }
            return {};
        }
        ...
        any multiply(const any &left, const any &right) const {
            if constexpr (type_traits::extras::meta_method::has_operator_mul_v<Ty> && not_bool) {
                return implements::any_magic_method_helper<any, Ty>(left, right, functional::multiplies{});
            }
            return {};
        }
        ...
        any divide(const any &left, const any &right) const {
            if constexpr (type_traits::extras::meta_method::has_operator_div_v<Ty> && not_bool) {
                return implements::any_magic_method_helper<any, Ty>(left, right, functional::divides{});
            }
            return {};
        }
        ...
        any mod(const any &left, const any &right) const {
            if constexpr (type_traits::extras::meta_method::has_operator_mod_v<Ty> && not_bool) {
                return implements::any_magic_method_helper<any, Ty>(left, right, functional::modulus{});
            }
            return {};
        }
        ...
        bool compare_less(const any &left, const any &right) const {
            if constexpr (type_traits::extras::meta_method::has_operator_lt_v<Ty>) {
                return implements::any_magic_method_helper<bool, Ty>(left, right, functional::less{});
            }
            return false;
        }
        ...
        bool compare_less_equal(const any &left, const any &right) const {
            if constexpr (type_traits::extras::meta_method::has_operator_le_v<Ty>) {
                return implements::any_magic_method_helper<bool, Ty>(left, right, functional::less_equal{});
            }
            return false;
        }
        ...
        bool compare_equal(const any &left, const any &right) const {
            if constexpr (type_traits::extras::meta_method::has_operator_eq_v<Ty>) {
                return implements::any_magic_method_helper<bool, Ty>(left, right, functional::equal<>{});
            }
            return false;
        }
        ...
        bool compare_greater_equal(const any &left, const any &right) const {
            if constexpr (type_traits::extras::meta_method::has_operator_gt_v<Ty>) {
                return implements::any_magic_method_helper<bool, Ty>(left, right, functional::greater_equal{});
            }
            return false;
        }
        ...
        bool compare_greater(const any &left, const any &right) const {
            if constexpr (type_traits::extras::meta_method::has_operator_ge_v<Ty>) {
                return implements::any_magic_method_helper<bool, Ty>(left, right, functional::greater{});
            }
            return false;
        }
    };
...
namespace rainy::foundation::container::implements {
    ...
    RAINY_CONSTEXPR_BOOL is_any_addable_v<Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::add)>> =
        true;
    ...
    RAINY_CONSTEXPR_BOOL
        has_any_plus_equal_v<Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::plus_equal)>> = true;

    template <typename Ty, typename Any, bool WithEqual = false, typename = void>
    RAINY_CONSTEXPR_BOOL is_any_subable_v = false;

    template <typename Ty, typename Any, bool WithEqual>
    RAINY_CONSTEXPR_BOOL is_any_subable_v<Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::subtract)>> =
        true;
    ...
    template <typename Ty, typename Any, bool WithEqual>
    RAINY_CONSTEXPR_BOOL
        is_any_multable_v<Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::multiply)>> = true;

    template <typename Ty, typename Any, bool WithEqual = false, typename = void>
    RAINY_CONSTEXPR_BOOL is_any_divable_v = false;

    template <typename Ty, typename Any, bool WithEqual>
    RAINY_CONSTEXPR_BOOL is_any_divable_v<Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::divide)>> =
        true;
    ...
    template <typename Ty, typename Any, bool WithEqual>
    RAINY_CONSTEXPR_BOOL is_any_modable_v<Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::mod)>> =
        true;
    ...
    template <typename Ty, typename Any, bool WithEqual>
    RAINY_CONSTEXPR_BOOL
        is_any_preincable_v<Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::incr_prefix)>> = true;
    ...
    template <typename Ty, typename Any, bool WithEqual>
    RAINY_CONSTEXPR_BOOL
        is_any_predecable_v<Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::decr_prefix)>> = true;
    ...
    template <typename Ty, typename Any, bool WithEqual>
    RAINY_CONSTEXPR_BOOL
        is_any_postincable_v<Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::incr_postfix)>> = true;
    ...
    template <typename Ty, typename Any, bool WithEqual>
    RAINY_CONSTEXPR_BOOL
        is_any_postdecable_v<Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::decr_postfix)>> = true;
    ...
    template <typename Ty, typename Any, bool WithEqual>
    RAINY_CONSTEXPR_BOOL
        is_any_less_compareable_v<Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::compare_less)>> =
            true;
    ...
    RAINY_CONSTEXPR_BOOL is_any_less_eq_compareable_v<
        Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::compare_less_equal)>> = true;
    ...
    template <typename Ty, typename Any, bool WithEqual>
    RAINY_CONSTEXPR_BOOL
        is_any_eq_compareable_v<Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::compare_equal)>> =
            true;
    ...
    template <typename Ty, typename Any, bool WithEqual>
    RAINY_CONSTEXPR_BOOL
        is_any_gt_compareable_v<Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::compare_greater)>> =
            true;
    ...
    RAINY_CONSTEXPR_BOOL is_any_greater_eq_compareable_v<
        Ty, Any, WithEqual, type_traits::other_trans::void_t<decltype(&any_magic_method<Ty, Any, WithEqual>::compare_greater_equal)>> = true;
}
...
namespace rainy::foundation::container::implements {
    ...
    void do_binary_operator_operation_impl(void *const data) {
        ...
        using any = Any;
        auto *res = static_cast<core::container::tuple<const any * /* left */, const any * /* right */, any * /* recv */> *>(data);
        auto &left = *core::container::get<0>(*res);
        auto &right = *core::container::get<1>(*res);
        auto &recv = *core::container::get<2>(*res);
        constexpr bool can_equal_for =
            !type_traits::type_relations::is_same_v<type_traits::modifers::remove_cvref_t<decltype(WhenIsTrueMemPtr)>, std::nullptr_t>;
        constexpr bool is_avaiable =
            !type_traits::type_relations::is_same_v<type_traits::modifers::remove_cvref_t<decltype(WhenIsFalseMemPtr)>, std::nullptr_t>;
        if (&recv == &left) {
    ...
    bool do_compare_operater_operation_impl(void *const data) {
        using any = Any;
        using pack = const core::container::tuple<const any *, const any *, any_compare_operation> *;
        const auto *res = static_cast<pack>(data);
        rainy_const left = core::container::get<0>(*res);
        rainy_const right = core::container::get<1>(*res);
    ...
    bool do_compare_operater_operation(void *const data) {
        ...
        using remove_cvref_t = type_traits::modifers::remove_cvref_t<Ty>;
    ...
    bool get_executer_impl_get_begin(void *const data) {
        ...
        if constexpr (type_traits::extras::iterators::has_iterator_v<remove_cvref_t>) {
            using tuple_t = core::container::tuple<bool /* is const */, typename any::reference * /* value */, typename any::iterator *
                                                   /* recv */>;
            using remove_ref_t = type_traits::modifers::remove_reference_t<Ty>;
            using const_as = type_traits::modifers::add_const_t<remove_ref_t>;
            using iterator = any_proxy_iterator<any, remove_cvref_t>;
            auto *res = static_cast<tuple_t *>(data);
            bool is_const = core::container::get<0>(*res);
            rainy_let *value = core::container::get<1>(*res);
            auto *recv = core::container::get<2>(*res);
            if constexpr (type_traits::extras::iterators::has_const_iterator_v<remove_ref_t>) {
                if (is_const || value->type().is_const()) {
                    ...
                    if constexpr (type_traits::extras::meta_method::has_cbegin_v<remove_ref_t>) {
                        ::new (recv)
                            typename any::iterator(std::in_place_type<const_iterator>, value->template as<const_as>().cbegin());
                    } else if constexpr (type_traits::extras::meta_method::has_begin_v<const_as>) {
                        ::new (recv)
                            typename any::iterator(std::in_place_type<const_iterator>, value->template as<const_as>().begin());
                    }
                }
            }
            if constexpr (type_traits::extras::meta_method::has_begin_v<remove_ref_t>) {
                if (!is_const && !value->type().is_const()) {
                    if constexpr (!type_traits::properties::is_const_v<remove_ref_t>) {
                        ::new (recv) typename any::iterator(std::in_place_type<iterator>, value->template as<remove_ref_t>().begin());
                    }
                }
            }
            return !recv->empty();
        } else if constexpr (type_traits::primary_types::is_bounded_array_v<remove_cvref_t>) {
            using tuple_t = core::container::tuple<bool /* is const */, typename any::reference * /* value */, typename any::iterator *
                                                   /* recv */>;
            using remove_ref_t = type_traits::modifers::remove_reference_t<Ty>;
            using const_as = type_traits::modifers::add_const_t<remove_ref_t>;
            ...
            if (is_const || value->type().is_const()) {
                using std::begin;
                ::new (recv) typename any::iterator(std::in_place_type<const_iterator>, begin(value->template as<const_as>()));
            } else {
                using std::begin;
                ::new (recv) typename any::iterator(std::in_place_type<iterator>, begin(value->template as<remove_ref_t>()));
            }
            return !recv->empty();
        }
        return false;
    ...
    bool get_executer_impl_get_end(void *const data) {
        ...
        if constexpr (type_traits::extras::iterators::has_iterator_v<Ty>) {
            ...
            if constexpr (type_traits::extras::iterators::has_const_iterator_v<remove_ref_t>) {
                if (is_const || value->type().is_const()) {
                    ...
                    if constexpr (type_traits::extras::meta_method::has_cend_v<remove_ref_t>) {
                        ::new (recv) typename any::iterator(std::in_place_type<const_iterator>, value->template as<const_as>().cend());
                    } else if constexpr (type_traits::extras::meta_method::has_end_v<const_as>) {
                        ::new (recv) typename any::iterator(std::in_place_type<const_iterator>, value->template as<const_as>().end());
                    }
                }
            }
            if constexpr (type_traits::extras::meta_method::has_end_v<remove_ref_t>) {
                if (!is_const && !value->type().is_const()) {
                    if constexpr (!type_traits::properties::is_const_v<remove_ref_t>) {
                        ::new (recv) typename any::iterator(std::in_place_type<iterator>, value->template as<remove_ref_t>().end());
                    }
                }
            }
            return !recv->empty();
            ...
            if (is_const || value->type().is_const()) {
                using std::end;
                ::new (recv) typename any::iterator(std::in_place_type<const_iterator>, end(value->template as<const_as>()));
            } else {
                using std::end;
                ::new (recv) typename any::iterator(std::in_place_type<iterator>, end(value->template as<remove_ref_t>()));
            }
            return !recv->empty();
        }
        return false;
...
namespace rainy::foundation::container::implements {
    ...
    bool any_execution_policy::invoke_impl(operation op, void *this_, void *const data) {
        using any = BasicAnyImpl;
        using remove_cvref_t = type_traits::modifers::remove_cvref_t<Ty>;
        if constexpr (type_traits::type_relations::is_same_v<type_traits::other_trans::decay_t<Ty>, any>) {
            ...
            switch (op) {
                ...
                case operation::mod: {
                    auto *res = static_cast<core::container::tuple<const any *, const any *, any *> *>(data);
                    auto &left_inner = const_cast<any &>((*core::container::get<0>(*res)).template as<any &>());
                    auto &right_inner = const_cast<any &>((*core::container::get<1>(*res)).template as<any &>());
                    auto patched = core::container::make_tuple(static_cast<const any *>(&left_inner), static_cast<const any *>(&right_inner),
                                                   core::container::get<2>(*res));
                    return inner_any.storage.executer->invoke(op, &inner_any, &patched);
                }
                case operation::compare: {
                    auto *res = static_cast<const core::container::tuple<const any *, const any *, any_compare_operation> *>(data);
                    auto &left_inner = const_cast<any &>((*core::container::get<0>(*res)).template as<any &>());
                    auto &right_inner = const_cast<any &>((*core::container::get<1>(*res)).template as<any &>());
                    auto patched = core::container::make_tuple(static_cast<const any *>(&left_inner), static_cast<const any *>(&right_inner),
                                                   core::container::get<2>(*res));
                ...
                case operation::decr_postfix: {
                    auto *res = static_cast<core::container::tuple<any *, any *> *>(data);
                    auto patched = core::container::make_tuple(&inner_any, core::container::get<1>(*res));
                    return inner_any.storage.executer->invoke(op, &inner_any, &patched);
                }
                case operation::dereference: {
                    auto *res = static_cast<core::container::tuple<bool, any *, any *> *>(data);
                    auto patched = core::container::make_tuple(core::container::get<0>(*res), &inner_any, core::container::get<2>(*res));
                    return inner_any.storage.executer->invoke(op, &inner_any, &patched);
                }
                case operation::construct_from: {
                    // Data: tuple<bool, reference*, any*>
                    // Patch the reference to point to a reference to the inner any
                    auto *res = static_cast<core::container::tuple<bool, typename any::reference *, any *> *>(data);
                    typename any::reference inner_ref(inner_any);
                    auto patched =core::container::make_tuple(core::container::get<0>(*res), &inner_ref, core::container::get<2>(*res));
                    return inner_any.storage.executer->invoke(op, &inner_any, &patched);
                }
                default:
            ...
            switch (op) {
                case operation::compare: {
                    rainy_let res =
                        static_cast<const core::container::tuple<const typename any::reference *, const typename any::reference *,
                                                                 any_compare_operation> *>(data);
                    switch (core::container::get<2>(*res)) {
                ...
                case operation::eval_hash: {
                    auto *res = static_cast<core::container::tuple<const typename any::reference *, std::size_t *> *>(data);
                    rainy_const object = core::container::get<0>(*res);
                    std::size_t *hashcode = core::container::get<1>(*res);
                ...
                case operation::query_for_is_tuple_like: {
                    if constexpr (constexpr std::size_t member_count = meta::member_count_v<type_traits::modifers::remove_cvref_t<Ty>>;
                                  member_count == 0) {
                        return false;
                    } else {
                ...
                case operation::destructre_this_pack: {
                    ...
                    if constexpr (constexpr std::size_t member_count = meta::member_count_v<remove_cvref_t>; member_count != 0) {
                        auto *res =
                            static_cast<core::container::tuple<any *, bool, collections::views::array_view<any_binding_package>> *>(
                                data);
                        any *object = core::container::get<0>(*res);
                        bool use_const = core::container::get<1>(*res);
                        auto &view = core::container::get<2>(*res);
                        using accessed_t = type_traits::modifers::remove_cvref_t<Ty>;
                        if (use_const) {
                            auto tuple_ptr = core::meta::struct_bind_tuple(const_cast<accessed_t &>(object->template as<Ty>()));
                           core::container::apply(
                                [&](auto *...elems) {
                                    std::size_t idx = 0;
                                    ((view[idx++] =
                ...
                case operation::output_any: {
                    auto *res = static_cast<core::container::tuple<bool /* is_char/is_wchar_t */, void * /* params */> *>(data);
                    bool is_char = core::container::get<0>(*res);
                    void *output_data = core::container::get<1>(*res);
                    if (is_char) {
                        if constexpr (is_char_any_can_output<Ty>) {
                            auto *out =
                                static_cast<core::container::tuple<std::basic_ostream<char> * /* ostream */, const any * /* any */> *>(
                                    output_data);
                            (*core::container::get<0>(*out)) << core::container::get<1>(*out)->template as<Ty>();
                            return true;
                        }
                    } else {
                        if constexpr (is_wchar_any_can_output<Ty>) {
                            auto *out = static_cast<core::container::tuple<std::basic_ostream<wchar_t> * /* ostream */, const any *
                                                                           /* any */> *>(output_data);
                            (*core::container::get<0>(*out)) << core::container::get<1>(*out)->template as<Ty>();
                            return true;
                        }
                ...
                case operation::incr_prefix: {
                    if constexpr (is_any_preincable_v<remove_cvref_t, any>) {
                        auto *res = static_cast<core::container::tuple<any * /* operand */, any * /* recv */> *>(data);
                        auto &left = *core::container::get<0>(*res);
                        auto &recv = *core::container::get<1>(*res);
                ...
                case operation::dereference: {
                    ...
                    auto *res = static_cast<core::container::tuple<bool /* is_const */, any * /* left */, any * /* recv */> *>(data);
                    bool is_const = core::container::get<0>(*res);
                    auto &value = (*core::container::get<1>(*res)).template as<Ty>();
                    any *recv = core::container::get<2>(*res);
                    if (is_const) {
                        if constexpr (has_operator_deref_v<type_traits::modifers::add_const_t<Ty>>) {
                            recv->template emplace<decltype(*value)>(*value);
                        }
                    } else {
                        if constexpr (has_operator_deref_v<Ty>) {
                            recv->template emplace<decltype(*value)>(*value);
                        } else if constexpr (has_operator_deref_v<type_traits::modifers::add_const_t<Ty>>) {
                            recv->template emplace<decltype(*value)>(*value);
                        }
                    }
                    break;
                ...
                case operation::access_element: {
                    ...
                    using remove_ref_t = type_traits::modifers::remove_reference_t<Ty>;
                    using const_as = type_traits::modifers::add_const_t<type_traits::modifers::remove_reference_t<Ty>>;
                    auto *res =
                        static_cast<core::container::tuple<bool /* is_const */, any * /* value */, any * /* recv */, const any *
                                                           /* index */> *>(data);
                    bool is_const = core::container::get<0>(*res);
                    rainy_let value = core::container::get<1>(*res);
                    auto &recv = *core::container::get<2>(*res);
                    auto &key = core::container::get<3>(*res);
                    if constexpr (type_traits::properties::is_sequential_container_v<remove_cvref_t> &&
                                  type_traits::extras::meta_method::has_operator_index_v<remove_ref_t>) {
                        ...
                        if (is_const || value->type().is_const()) {
                            if constexpr (type_traits::extras::meta_method::has_operator_index_v<const_as>) {
                                const auto &extract = (*core::container::get<1>(*res)).template as<const_as>();
                                ::new (&recv) any(utility::forward<access_elements_construct_type<elem_t>>(extract[index]));
                            }
                        } else {
                            auto &extract = (*core::container::get<1>(*res)).template as<Ty>();
                            ::new (&recv) any(utility::forward<elem_t>(extract[index]));
                        }
                        has_value = recv.has_value();
                    } else if constexpr (type_traits::properties::is_map_like_v<remove_cvref_t> &&
                                         type_traits::extras::meta_method::has_operator_index_for_key_v<remove_cvref_t>) {
                        ...
                        if (is_const || value->type().is_const()) {
                            if constexpr (type_traits::extras::meta_method::has_operator_index_for_key_v<const_as>) {
                                const auto &extract = (*core::container::get<1>(*res)).template as<const_as>();
                                ::new (&recv)
                                    any(utility::forward<access_elements_construct_type<elem_t>>(extract[utility::move(key_val)]));
                            }
                        } else {
                            auto &extract = (*core::container::get<1>(*res)).template as<Ty>();
                            constexpr bool type_is_const = type_traits::properties::is_const_v<type_traits::modifers::remove_reference_t<Ty>>;
                            if constexpr (type_is_const) {
                                constexpr bool has_operator_in_const = type_traits::extras::meta_method::has_operator_index_for_key_v<
                                    type_traits::modifers::add_const_t<remove_cvref_t>>;
                                if constexpr (has_operator_in_const) {
                                    ::new (&recv)
                                        any(utility::forward<access_elements_construct_type<elem_t>>(extract[utility::move(key_val)]));
                                }
                            } else {
                                ::new (&recv) any(utility::forward<elem_t>(extract[utility::move(key_val)]));
                            }
                        }
                        has_value = recv.has_value();
                    } else if constexpr (type_traits::primary_types::is_bounded_array_v<remove_cvref_t> &&
                                         type_traits::extras::meta_method::has_operator_index_v<remove_ref_t>) {
                        using elem_t = type_traits::modifers::remove_extent_t<remove_cvref_t>;
                        std::size_t index{};
                        if (key->template is<std::size_t>()) {
                            index = key->template as<std::size_t>();
                        } else if (key->template is_convertible<std::size_t>()) {
                        ...
                        constexpr auto find_fn = [](bool is_const_, const std::size_t index_, auto &&recv_var, auto &&extract) {
                            ...
                            apply(
                                [&](auto &&...elems) { // NOLINT
                                    ...
                                    (void) ((i++ == index_
                                                 ? (is_const_
                                                        ? recv_var.template emplace<access_elements_construct_type<decltype(elems)>>(
                                                              elems)
                ...
                case operation::assign: {
                    ...
                    constexpr bool can_assign =
                        type_traits::extras::meta_method::has_operator_assign_v<Ty> && !type_traits::properties::is_const_v<remove_ref_t>;
                    if constexpr (can_assign) {
                        using tuple_t = core::container::tuple<typename any::reference *, any>;
                        auto *res = static_cast<tuple_t *>(data);
                        auto *left = core::container::get<0>(*res);
                        auto &right = core::container::get<1>(*res);
                        auto &left_operand =
                            *static_cast<type_traits::modifers::remove_cvref_t<Ty> *>(const_cast<void *>(left->target_as_void_ptr()));
                ...
                case operation::get_reference: {
                    using add_const = type_traits::modifers::add_const_t<type_traits::other_trans::conditional_t<
                        type_traits::composite_types::is_reference_v<Ty>,
                        type_traits::other_trans::conditional_t<type_traits::primary_types::is_rvalue_reference_v<Ty>,
                                                                type_traits::modifers::add_rvalue_reference_t<remove_cvref_t>,
                                                                type_traits::modifers::add_lvalue_reference_t<remove_cvref_t>>,
                        remove_cvref_t>>;
                    using tuple_t = core::container::tuple<bool, any *, typename any::reference *>;
                    auto *res = static_cast<tuple_t *>(data);
                    bool is_const = core::container::get<0>(*res);
                    auto *value = core::container::get<1>(*res);
                    auto *reference = core::container::get<2>(*res);
                    if (is_const) {
                ...
                case operation::get_lvalue_reference: {
                    using add_const = type_traits::modifers::add_lvalue_reference_t<type_traits::modifers::add_const_t<Ty>>;
                    using tuple_t = core::container::tuple<bool, any *, typename any::reference *>;
                    auto *res = static_cast<tuple_t *>(data);
                    bool is_const = core::container::get<0>(*res);
                    auto *value = core::container::get<1>(*res);
                ...
                case operation::get_rvalue_reference: {
                    using add_const = type_traits::modifers::add_rvalue_reference_t<type_traits::modifers::add_const_t<Ty>>;
                    using tuple_t = core::container::tuple<bool, any *, typename any::reference *>;
                    auto *res = static_cast<tuple_t *>(data);
                    bool is_const = core::container::get<0>(*res);
                    auto *value = core::container::get<1>(*res);
                    auto *reference = core::container::get<2>(*res);
                    if (is_const) {
                        ::new (reference) typename any::reference(utility::move(value->template as<add_const>()));
                    } else {
                        ::new (reference) typename any::reference(utility::move(value->template as<type_traits::modifers::add_rvalue_reference_t<Ty>>()));
                    }
                    return true;
                }
                case operation::construct_from: {
                    using add_const = type_traits::modifers::add_const_t<type_traits::other_trans::conditional_t<
                        ...
                        type_traits::other_trans::conditional_t<type_traits::primary_types::is_rvalue_reference_v<Ty>,
                                                                ...
                                                                type_traits::modifers::add_lvalue_reference_t<remove_cvref_t>>,
                        remove_cvref_t>>;
                    using tuple_t = core::container::tuple<bool, typename any::reference *, any *>;
                    auto *res = static_cast<tuple_t *>(data);
                    bool is_const = core::container::get<0>(*res);
                    auto *left = core::container::get<1>(*res);
                    auto *value = core::container::get<2>(*res);
                    if (is_const) {
                        value->template emplace<remove_cvref_t>(left->template as<add_const>());
                    } else {
                        if (left->type().is_rvalue_reference()) {
                            value->template emplace<remove_cvref_t>(utility::move(left->template as<type_traits::modifers::add_rvalue_reference_t<Ty>>()));
                        } else {
                ...
                case operation::swap_value: {
                    if constexpr (type_traits::properties::is_swappable_v<Ty>) {
                        using tuple_t = core::container::tuple<any *, any *>;
                        auto *res = static_cast<tuple_t *>(data);
                        auto *left = core::container::get<0>(*res);
                        if (auto *value = core::container::get<1>(*res); left->type().is_compatible(value->type())) {
                            using std::swap;
                ...
                case operation::query_inner_declaertion_type: {
                    using the_type = type_traits::modifers::remove_cvref_t<Ty>;
                    using tuple_t = core::container::tuple<any_inner_declaertion, core::typeinfo *>;
                    auto *res = static_cast<tuple_t *>(data);
                    any_inner_declaertion query = core::container::get<0>(*res);
                    core::typeinfo &type = *core::container::get<1>(*res);
                    switch (query) {
                ...
                case operation::container_size: {
                    using tuple_t = core::container::tuple<any *, std::size_t *>;
                    using const_as = type_traits::modifers::add_const_t<remove_cvref_t>;
                    auto *res = static_cast<tuple_t *>(data);
                    auto *left = core::container::get<0>(*res);
                    std::size_t &new_size = *core::container::get<1>(*res);
                    if constexpr (type_traits::extras::meta_method::has_size_v<const_as>) {
                        new_size = std::size(left->template as<Ty>());
                        return true;
                    } else if constexpr (type_traits::primary_types::is_bounded_array_v<remove_cvref_t>) {
                        new_size = type_traits::modifers::extent_v<remove_cvref_t>;
                        return true;
                    }
                    break;
                }
                ...
                case operation::container_insert_seq_like: {
                    ...
                    using tuple_t = core::container::tuple<any *, const_iterator *, const_iterator *, const any *>;
                    auto *res = static_cast<tuple_t *>(data);
                    auto *this_pointer = core::container::get<0>(*res);
                    const_iterator &iterator = *core::container::get<1>(*res);
                    const_iterator &pos_iter = *core::container::get<2>(*res);
                    const any &value = *core::container::get<3>(*res);
                    if constexpr (type_traits::extras::meta_method::has_insert_for_iter_and_value_v<the_type> &&
                        ...
                        if (value.template is<value_type>()) {
                            ::new (&iterator)
                                const_iterator(std::in_place_type<iterator_type>,
                            ...
                            ::new (&iterator) const_iterator(
                                std::in_place_type<iterator_type>,
                ...
                case operation::container_insert_map_like: {
                    using the_type = type_traits::modifers::remove_cvref_t<Ty>;
                    using const_iterator = typename any::const_iterator;
                    using ret_pair_t = core::container::pair<const_iterator, bool>;
                    using tuple_t = core::container::tuple<any *, ret_pair_t *, const any *, const any *>;
                    auto *res = static_cast<tuple_t *>(data);
                    auto *this_pointer = core::container::get<0>(*res);
                    ret_pair_t *pair = core::container::get<1>(*res);
                    const any *key = core::container::get<2>(*res);
                    const any *value = core::container::get<3>(*res);
                    if (value == nullptr) {
                        if constexpr (type_traits::extras::meta_method::has_insert_for_key_v<the_type> &&
                                      !type_traits::properties::is_const_v<Ty>) {
                            ...
                            if (key->template is<key_type>()) {
                                auto [key_iterator, has_success] =
                                    this_pointer->template as<Ty>().insert(key->template as<key_type>());
                        ...
                        if constexpr (type_traits::properties::is_map_like_v<remove_cvref_t> &&
                                      !type_traits::properties::is_const_v<Ty>) {
                            using iterator = const_any_proxy_iterator<any, the_type>;
                            using key_type = typename the_type::key_type;
                            using mapped_type = typename the_type::mapped_type;
                            using value_type = typename the_type::value_type;
                            using insert_result_t =
                                decltype(utility::declval<the_type &>().insert(utility::declval<value_type>()));
                            if constexpr (core::meta::is_pair_v<insert_result_t>) {
                                if (key->template is<key_type>() && value->template is<mapped_type>()) {
                                    auto [key_iterator, has_success] = this_pointer->template as<Ty>().insert(
                                        value_type(key->template as<key_type>(), value->template as<mapped_type>()));
                                    ::new (&pair->first) const_iterator(std::in_place_type<iterator>, key_iterator);
                                    pair->second = has_success;
                                    return true;
                                }
                                if (key->template is_convertible<key_type>() && value->template is_convertible<mapped_type>()) {
                                    auto [key_iterator, has_success] = this_pointer->template as<Ty>().insert(
                                        value_type(key->template convert<key_type>(), value->template convert<mapped_type>()));
                                    ::new (&pair->first) const_iterator(std::in_place_type<iterator>, key_iterator);
                                    pair->second = has_success;
                                    return true;
                                }
                ...
                case operation::format: {
                    using the_type = type_traits::modifers::remove_cvref_t<Ty>;
                    using tuple_t = core::container::tuple<void *, void *, bool>;
                    auto *res = static_cast<tuple_t *>(data);
                    auto *parse_pointer = core::container::get<0>(*res);
                    auto *string_pointer = core::container::get<1>(*res);
                    const bool use_wchar = core::container::get<2>(*res);
                    auto *this_pointer = static_cast<any *>(this_);
                    const auto *target = static_cast<const the_type *>(this_pointer->target_as_void_ptr());
                    if (target == nullptr) {
                        return false;
                    }
                    if (use_wchar) {
                        using char_type = wchar_t;
                        if constexpr (core::text::is_formattable_v<the_type, char_type>) {
                            using format_t = core::text::basic_format_context<core::text::format_buffer_iterator<char_type>, char_type>;
                            auto &parse_context = *static_cast<core::text::basic_format_parse_context<char_type> *>(parse_pointer);
                            auto &out = *static_cast<core::text::basic_string<char_type> *>(string_pointer);
                            core::text::formatter<the_type, char_type> formatter_object;
                            parse_context.advance_to(formatter_object.parse(parse_context));
                            format_t format_context{utility::back_inserter(out), core::text::basic_format_args<format_t>{}};
                            format_context.advance_to(formatter_object.format(*target, format_context));
                            return true;
                        }
                    } else {
...
namespace rainy::foundation::container::implements {
    ...
    void call_handler_with_array(Fx &&handler, const core::collections::array<implements::any_binding_package, N> &array,
        ...
        utility::invoke(
            ...
            utility::forward<type_traits::other_trans::conditional_t<
                Const, type_traits::modifers::add_const_t<typename type_at<Is, type_list>::type>,
                typename type_at<Is, type_list>::type>>(
                convert_any_binding_package<type_traits::other_trans::conditional_t<
                                                Const, type_traits::modifers::add_const_t<typename type_at<Is, type_list>::type>,
                                                typename type_at<Is, type_list>::type>,
                                            Is>::impl(array[Is]))...);
    }
    ...
    void fill_tuple_with_array(Tuple &tuple, const core::collections::array<implements::any_binding_package, N> &array,
                               type_traits::helper::index_sequence<Is...>) {
        using namespace type_traits::other_trans;
        using std::swap;
        utility::destroy_at(&tuple);
        using type_list = typename tuple_like_to_type_list<type_traits::modifers::remove_cvref_t<Tuple>>::type;
        ::new (&tuple) Tuple(utility::forward<type_traits::other_trans::conditional_t<
                                 Const, type_traits::modifers::add_const_t<typename type_at<Is, type_list>::type>,
                                 typename type_at<Is, type_list>::type>>(
            convert_any_binding_package<type_traits::other_trans::conditional_t<
                                            Const, type_traits::modifers::add_const_t<typename type_at<Is, type_list>::type>,
    ...
    template <bool Const, std::size_t N, typename Tuple, std::size_t... Is>
    void fill_structure_with_array(Tuple &so_as_tuple, const core::collections::array<implements::any_binding_package, N> &array,
                                   type_traits::helper::index_sequence<Is...>) {
        using namespace std;
        using std::swap;
        Tuple tmp{so_as_tuple};
        (((*core::container::get<Is>(tmp)) = implements::convert_any_binding_package<
              type_traits::other_trans::conditional_t<
                  Const,
                  type_traits::modifers::add_const_t<
                      type_traits::modifers::remove_pointer_t<core::container::tuple_element_t<Is, Tuple>>>,
                  type_traits::modifers::remove_pointer_t<core::container::tuple_element_t<Is, Tuple>>>,
              Is>::impl(array[Is])),
         ...);
    ...
    void fill_pair_with_array(Pair &pair, const core::collections::array<implements::any_binding_package, 2> &array) {
        ...
        static_assert(type_traits::properties::is_copy_assignable_v<first_type>, "The first element of pair-like type is not assignable");
        static_assert(type_traits::properties::is_copy_assignable_v<second_type>, "The second element of pair-like type is not assignable");
        first = convert_any_binding_package<
            type_traits::other_trans::conditional_t<Const, type_traits::modifers::add_const_t<first_type>, first_type>,
            0>::impl(array[0]); // NOLINT
        second = convert_any_binding_package<
            type_traits::other_trans::conditional_t<Const, type_traits::modifers::add_const_t<second_type>, second_type>,
    ...
    bool destructure_impl(const BasicAny *view, const any_execution_policy *executer, Ty &&receiver) {
        ...
        core::container::tuple tuple{view, UseConst, collections::views::make_array_view(array)};
        ...
        if constexpr (type_traits::primary_types::function_traits<Ty>::valid &&
                      !type_traits::composite_types::is_member_pointer_v<Ty>) {
            ...
            return true;
        } else if constexpr (meta::member_count_v<type_traits::modifers::remove_cvref_t<Ty>> != 0) {
            auto so_as_tuple = core::meta::struct_bind_tuple(receiver);
