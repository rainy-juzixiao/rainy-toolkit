...
TEST_CASE("Constructing and destructing condition_variable", "[condition_variable]") {
...
TEST_CASE("Wait and notify_one functionality", "[condition_variable]") {
    SECTION("A condition variable and a mutex") {
        condition_variable cv;
        mutex mtx;
...
TEST_CASE("Wait and notify_all functionality", "[condition_variable]") {
    SECTION("A condition variable and multiple threads waiting") {
        condition_variable cv;
        mutex mtx;
