...
namespace rainy::foundation::io::filesystem::implements {
    ...
    using native_string_t = core::text::basic_string<native_char>;
    ...
    RAINY_INLINE native_string_t to_native(text::basic_string_view<char> sv) {
        using conv_t = core::text::wstring_convert<core::text::codecvt_utf8<wchar_t>, text::basic_string, wchar_t>;
        conv_t conv;
    ...
    RAINY_INLINE native_string_t to_native(text::basic_string_view<char16_t> sv) {
        using u16_conv = core::text::wstring_convert<core::text::codecvt_utf8<char16_t>, text::basic_string, char16_t>;
        using w_conv = core::text::wstring_convert<core::text::codecvt_utf8<wchar_t>, text::basic_string, wchar_t>;
        u16_conv c1;
        w_conv c2;
    ...
    RAINY_INLINE native_string_t to_native(text::basic_string_view<char32_t> sv) {
        using u32_conv = core::text::wstring_convert<core::text::codecvt_utf8<char32_t>, text::basic_string, char32_t>;
        using w_conv = core::text::wstring_convert<core::text::codecvt_utf8<wchar_t>, text::basic_string, wchar_t>;
        u32_conv c1;
        w_conv c2;
        auto utf8 = c1.to_bytes(sv.data(), sv.data() + sv.size());
    ...
    RAINY_INLINE native_string_t to_native(const text::basic_string_view<char16_t> sv) {
        using conv_t = core::text::wstring_convert<core::text::codecvt_utf8<char16_t>, text::basic_string, char16_t>;
        conv_t conv;
        return conv.to_bytes(sv.data(), sv.data() + sv.size());
    }

    RAINY_INLINE native_string_t to_native(const text::basic_string_view<char32_t> sv) {
        using conv_t = core::text::wstring_convert<core::text::codecvt_utf8<char32_t>, text::basic_string, char32_t>;
        conv_t conv;
        return conv.to_bytes(sv.data(), sv.data() + sv.size());
    }
