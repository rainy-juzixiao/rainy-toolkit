...
namespace rainy::foundation::io::filesystem {
    ...
    public:
        ...
        RAINY_NODISCARD operator const filesystem::path &() const noexcept;
        ...
        friend std::basic_ostream<CharType, Traits> &operator<<(std::basic_ostream<CharType, Traits> &ostream,
