...
namespace rainy::foundation::io::filesystem {
    ...
    using core::layer::copy_options;
    using core::layer::directory_options;
    using core::layer::file_type;
    using core::layer::perm_options;
    using core::layer::perms;
    using core::layer::space_info;
