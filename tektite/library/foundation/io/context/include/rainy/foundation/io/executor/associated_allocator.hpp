...
namespace rainy::foundation::io {
    template <typename Ty, typename ProtoAllocator = core::memory::allocator<void>, typename = void>
    ...
    template <typename Ty, typename ProtoAllocator = core::memory::allocator<void>>
