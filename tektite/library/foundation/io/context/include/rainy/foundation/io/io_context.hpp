...
namespace rainy::foundation::io {
    ...
    public:
        ...
        protected:
            core::layer::thrd_result associate_handle(implements::completion_op *op, std::uintptr_t fd, void *extra) { // NOLINT
    ...
    private:
        core::memory::nebula_ptr<implements::io_context_impl_base> impl_;
    };
}
