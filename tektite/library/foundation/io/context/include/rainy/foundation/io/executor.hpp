 ...
 */
#ifndef RAINY_FOUNDATION_IO_EXECUTOR_HPP
#define RAINY_FOUNDATION_IO_EXECUTOR_HPP
...
namespace rainy::foundation::exceptions::io {
    class bad_executor : public core::exceptions::exception {
    public:
...
namespace rainy::foundation::io {
    ...
    private:
        ...
        private:
            mutable core::concurrency::atomic_int ref_count_;
            Executor executor_;
        ...
        RAINY_NODISCARD impl_base *get_impl() const {
            if (!impl_) {
                ...
                core::exceptions::throw_exception(ex);
            }
            return impl_;
        }
