...
namespace rainy::foundation::io {
    ...
    public:
        ...
        rain_fn operator()(Args &&...args)->type_traits::properties::invoke_result_t<target_type, Args...> {
            return this->target_(utility::forward<Args>(args)...);
        }

        template <typename... Args>
        rain_fn operator()(Args &&...args) const->type_traits::properties::invoke_result_t<target_type, Args...> {
            return this->target_(utility::forward<Args>(args)...);
        }
    };
