...
namespace rainy::foundation::io {
    ...
    template <typename Ty, class Executor>
...
#define NET_TS_DEFINE_TAGGED_HANDLER_ALLOCATOR_PTR(purpose, op)                                                                       \
    struct ptr {                                                                                                                      \
        ...
        static op *allocate(const Alloc &a) {                                                                                         \
            using recycling_allocator_type = typename ::rainy::core::memory::get_recycling_allocator<Alloc, purpose>::type;           \
            NET_TS_REBIND_ALLOC(recycling_allocator_type, op)                                                                         \
            a1(::rainy::core::memory::get_recycling_allocator<Alloc, purpose>::get(a));                                               \
        ...
        void reset() {                                                                                                                \
            ...
            if (v) {                                                                                                                  \
                typedef typename ::rainy::core::memory::get_recycling_allocator<Alloc, purpose>::type recycling_allocator_type;       \
                NET_TS_REBIND_ALLOC(recycling_allocator_type, op)                                                                     \
                a1(::rainy::core::memory::get_recycling_allocator<Alloc, purpose>::get(*a));                                          \
