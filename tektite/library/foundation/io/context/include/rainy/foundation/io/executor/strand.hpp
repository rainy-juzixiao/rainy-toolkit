...
namespace rainy::foundation::io::implements {
    ...
    public:
        ...
        static void dispatch(const implementation_type &impl, Executor &ex, Function &&function, const Allocator &a) {
            ...
            if (current_thread_strand() == impl.get()) {
                ...
                core::concurrency::fenced_block b(core::concurrency::fenced_block::full);
    ...
    private:
            ...
            struct on_invoker_exit {
                ...
                ~on_invoker_exit() {
                    ...
                    if (more_handlers) {
                        ...
                        core::memory::recycling_allocator<void> allocator;
        ...
        concurrency::mutex mutex_;
        core::memory::nebula_ptr<concurrency::mutex> mutexes_[num_mutexes];
        std::size_t salt_;
    };
}
