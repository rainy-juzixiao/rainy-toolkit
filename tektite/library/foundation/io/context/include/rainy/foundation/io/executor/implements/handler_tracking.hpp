...
namespace rainy::foundation::io::implements {
    ...
    public:
        ...
        static void write_line(const core::text::string_view fmt, Args &&...args) {
#if RAINY_ENABLE_DEBUG
            auto str = core::text::format(fmt, utility::forward<Args>(args)...);
    ...
    private:
        ...
        struct tracking_state {
            ...
            core::concurrency::atomic<uint64_t> next_handler_id{0};
