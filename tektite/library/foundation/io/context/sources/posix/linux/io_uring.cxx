...
namespace rainy::foundation::io::implements {
    ...
    public:
        ...
        core::layer::thrd_result submit_sqe() noexcept {
            const int ret = ::io_uring_submit(&ring_);
            return (ret >= 0) ? core::layer::thrd_result::success : core::layer::thrd_result::error;
        }
...
namespace rainy::foundation::io::implements {
    core::memory::nebula_ptr<io_context_impl_base> create_io_context_impl(int concurrency_hint) {
        auto impl = core::memory::make_nebula<io_uring_impl>(concurrency_hint);
