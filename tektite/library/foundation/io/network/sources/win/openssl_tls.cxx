...
namespace rainy::foundation::io::net::implements {
    class openssl_not_implement_error : public core::exceptions::logic::logic_error {
    public:
    ...
    static void throw_openssl_not_implement_error(
        const core::diagnostics::source_location &location = core::diagnostics::source_location::current()) {
