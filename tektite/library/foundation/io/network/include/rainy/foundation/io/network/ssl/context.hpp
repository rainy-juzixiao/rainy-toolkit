...
#include <rainy/foundation/io/network/implements/ssl_impl.hpp>
...
namespace rainy::foundation::io::net::ssl {
    ...
    private:
        core::collections::vector<core::container::pair<text::string, text::string>> certificate_files;
        core::collections::vector<text::string> certificate_chain_files;
        core::collections::vector<core::container::pair<text::string, text::string>> private_key_files;
        core::collections::vector<core::container::pair<const void *, std::size_t>> certificate_buffers;
        bool use_system_store_flag = false;
        core::collections::vector<text::string> verify_paths;
    ...
    public:
        ...
        void set_alpn_protos(const core::collections::vector<text::string> &protos);
        ...
        RAINY_NODISCARD const core::collections::vector<text::string>& alpn_protos() const;
        ssl::verify_mode verify_mode() const noexcept;

    private:
        core::memory::nebula_ptr<implements::ssl_context_impl_base> impl_;
    };
}
