...
namespace rainy::foundation::io::net::ssl {
    ...
    public:
        ...
        void set_server_name(const core::text::string &hostname) {
        ...
        core::text::string server_name() const {
            return server_name_;
        }
        ...
        auto async_handshake(CompletionToken &&token) ->
            typename async_result<type_traits::other_trans::decay_t<CompletionToken>, void(std::error_code)>::return_type {
    ...
    private:
        ...
        context &context_;
        core::memory::nebula_ptr<implements::ssl_stream_impl_base> impl_;
        core::text::string server_name_;
    };
}
