...
namespace rainy::foundation::io::net::implements {
    ...
    public:
        ...
        virtual std::error_code set_alpn_protos(const core::collections::vector<text::string> &protos) noexcept = 0;
        ...
        virtual const core::collections::vector<text::string> &alpn_protos() const noexcept = 0;
    ...
    RAINY_TOOLKIT_API core::memory::nebula_ptr<ssl_context_impl_base> create_ssl_context_impl();
    RAINY_TOOLKIT_API core::memory::nebula_ptr<ssl_stream_impl_base> create_ssl_stream_impl();
}
