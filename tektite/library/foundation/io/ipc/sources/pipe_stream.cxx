 ...
 */
#include <rainy/foundation/io/ipc/pipe_stream.hpp>
...
namespace rainy::foundation::io::ipc::stream {
    named_pipe_stream named_pipe_stream::open_server(executor_type executor, core::text::string_view name,
                                                     pipe_direction dir) {
        std::error_code ec;
    ...
    named_pipe_stream named_pipe_stream::open_server(executor_type executor, core::text::string_view name, pipe_direction dir,
                                                     std::error_code &ec) {
    ...
    named_pipe_stream named_pipe_stream::open_client(executor_type executor, core::text::string_view name, pipe_direction dir) {
        std::error_code ec;
