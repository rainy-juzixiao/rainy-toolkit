...
#include <rainy/foundation/io/ipc/implements/descriptor.hpp>
#include <windows.h>
...
namespace rainy::foundation::io::ipc::stream::implements {
    ...
    public:
        ...
        void async_read_some(void *, std::size_t, executor_type, completion_op *op) noexcept override {
            op_result result{};
            result.user_data = op;
            result.error_code = 0;
            result.bytes_transferred = 0;
    ...
    core::memory::nebula_ptr<descriptor_impl_base> create_descriptor_impl(executor_type executor) {
        return core::memory::make_nebula<win_descriptor_impl>(executor);
    }
    ...
    core::memory::nebula_ptr<descriptor_impl_base> create_descriptor_impl_from_native(executor_type executor, native_handle_type handle) {
        auto impl = core::memory::make_nebula<win_descriptor_impl>(executor);
    ...
    core::memory::nebula_ptr<descriptor_impl_base> create_console_impl(executor_type executor, console_stream_kind kind) {
        ...
        switch (kind) {
            ...
            case console_stream_kind::error:
                ...
                break;
            default:
                return core::memory::make_nebula<null_descriptor_impl>(executor);
        }
    ...
    container::pair<core::memory::nebula_ptr<descriptor_impl_base>, core::memory::nebula_ptr<descriptor_impl_base>> create_pipe_impl(
        ...
        auto read_impl = core::memory::make_nebula<anon_pipe_descriptor_impl>(executor);
        auto write_impl = core::memory::make_nebula<anon_pipe_descriptor_impl>(executor);
    ...
    core::memory::nebula_ptr<descriptor_impl_base> create_named_pipe_server_impl(executor_type executor, const char *name,
        ...
        rainy::core::text::wstring wide_name;
        {
        ...
        if (wide_name.find(L"\\\\.\\pipe\\") == rainy::core::text::wstring::npos) {
            wide_name.insert(static_cast<rainy::core::text::wstring::size_type>(0), L"\\\\.\\pipe\\");
        }
        DWORD access{};
        switch (dir) {
    ...
    core::memory::nebula_ptr<descriptor_impl_base> create_null_impl(executor_type executor) {
        return core::memory::make_nebula<null_descriptor_impl>(executor);
    }
}
