 ...
 */
#ifndef RAINY_FOUNDATION_IO_IPC_IMPLEMENTS_DESCRIPTOR_HPP
#define RAINY_FOUNDATION_IO_IPC_IMPLEMENTS_DESCRIPTOR_HPP
#include <rainy/foundation/io/io_context.hpp>
#include <rainy/foundation/io/ipc/fwd.hpp>
#include <system_error>

namespace rainy::foundation::io::ipc::stream::implements {
    ...
    RAINY_TOOLKIT_API core::memory::nebula_ptr<descriptor_impl_base> create_descriptor_impl(executor_type executor);

    RAINY_TOOLKIT_API core::memory::nebula_ptr<descriptor_impl_base> create_console_impl(executor_type executor, console_stream_kind kind);

    RAINY_TOOLKIT_API container::pair<core::memory::nebula_ptr<descriptor_impl_base>, core::memory::nebula_ptr<descriptor_impl_base>>
    create_pipe_impl(executor_type executor, std::error_code &ec);
    RAINY_TOOLKIT_API core::memory::nebula_ptr<descriptor_impl_base> create_named_pipe_server_impl(executor_type executor, const char *name,
                                                                                             pipe_direction dir, std::error_code &ec);

    RAINY_TOOLKIT_API core::memory::nebula_ptr<descriptor_impl_base> create_named_pipe_client_impl(executor_type executor, const char *name,
                                                                                             pipe_direction dir, std::error_code &ec);

    RAINY_TOOLKIT_API core::memory::nebula_ptr<descriptor_impl_base> create_null_impl(executor_type executor);
    RAINY_TOOLKIT_API core::memory::nebula_ptr<descriptor_impl_base> create_descriptor_impl_from_native(executor_type executor,
