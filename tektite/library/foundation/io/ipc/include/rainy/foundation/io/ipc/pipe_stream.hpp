 ...
 */
#ifndef RAINY_FOUNDATION_IO_IPC_PIPE_STREAM_HPP
#define RAINY_FOUNDATION_IO_IPC_PIPE_STREAM_HPP
...
namespace rainy::foundation::io::ipc::stream {
    ...
    protected:
        explicit pipe_end_base(executor_type ex, core::memory::nebula_ptr<implements::descriptor_impl_base> impl) noexcept :
        ...
        core::memory::nebula_ptr<implements::descriptor_impl_base> impl_;
    };
    ...
    public:
        ...
        static named_pipe_stream open_server(executor_type executor, core::text::string_view name,
                                             pipe_direction dir = pipe_direction::inout);

        static named_pipe_stream open_server(executor_type executor, core::text::string_view name, pipe_direction dir,
                                             std::error_code &ec);

        static named_pipe_stream open_client(executor_type executor, core::text::string_view name,
                                             pipe_direction dir = pipe_direction::inout);

        static named_pipe_stream open_client(executor_type executor, core::text::string_view name, pipe_direction dir,
                                             std::error_code &ec);
    ...
    private:
        explicit named_pipe_stream(executor_type ex, core::memory::nebula_ptr<implements::descriptor_impl_base> impl) noexcept :
            executor_(ex), impl_(utility::move(impl)) {
        }
