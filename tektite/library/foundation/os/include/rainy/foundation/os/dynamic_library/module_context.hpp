...
namespace rainy::foundation::dynamic_library::implements {
     ...
     */
    RAINY_TOOLKIT_API core::handle load_module(core::text::string_view module_path, bool crossplatform) noexcept;
     ...
     * @return 如果成功，返回该模块的句柄，失败则返回空句柄
     */
    RAINY_TOOLKIT_API core::handle try_to_get_module(core::text::string_view module_path, bool crossplatform) noexcept;
     ...
     */
    RAINY_TOOLKIT_API farproc_fn load_symbol(core::handle handle, core::text::string_view symbol_name) noexcept;
...
namespace rainy::foundation::dynamic_library {
    ...
    public:
         ...
         */
        bool load(core::text::string_view module_path) noexcept;
         ...
         */
        bool try_get_module(core::text::string_view module_path) noexcept;
        ...
        bool load_symbol_to(const core::text::string_view symbol_name, Fx *&fx) noexcept {
