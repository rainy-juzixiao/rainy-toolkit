...
namespace rainy::foundation::container::implements {
    ...
    struct tuple_val {
        ...
        constexpr tuple_val(tuple_val &&other) noexcept(type_traits::properties::is_nothrow_move_constructible_v<Ty>) :
        ...
        constexpr tuple_val &operator=(tuple_val &&other) noexcept(type_traits::properties::is_nothrow_move_assignable_v<Ty>) {
            if (this != &other) {
                value = utility::move(other.value);
            }
            return *this;
        ...
        template <typename Other,
                  type_traits::other_trans::enable_if_t<
                      type_traits::properties::is_constructible_v<Ty, Other &&> &&
    ...
    public:
        ...
        template <typename HeadArg, typename... RestArgs,
                  type_traits::other_trans::enable_if_t<sizeof...(RestArgs) == sizeof...(Rest) &&
                                                            type_traits::properties::is_constructible_v<Head, HeadArg> &&
                                                            (type_traits::properties::is_constructible_v<Rest, RestArgs> && ...),
                                                        int> = 0>
        ...
        template <
            ...
            type_traits::other_trans::enable_if_t<
                sizeof...(OtherRest) == sizeof...(Rest) && type_traits::properties::is_constructible_v<Head, const OtherHead &> &&
                    (type_traits::properties::is_constructible_v<Rest, const OtherRest &> && ...),
                int> = 0>
