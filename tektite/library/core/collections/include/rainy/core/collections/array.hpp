 ...
 */
#ifndef RAINY_CORE_COLLECTIONS_ARRAY_HPP
#define RAINY_CORE_COLLECTIONS_ARRAY_HPP
#include <array>
#include <exception>
...
namespace rainy::collections::implements {
    ...
    struct array_traits {
        ...
        using is_swappable = type_traits::properties::is_swappable<Ty>;
        using is_nothrow_swappable = type_traits::properties::is_nothrow_swappable<Ty>;
        using is_nothrow_assignable = type_traits::helper::bool_constant<type_traits::properties::is_nothrow_move_assignable_v<Ty> &&
...
namespace rainy::collections {
    ...
    public:
        ...
        RAINY_NODISCARD constexpr rain_fn slice(std::size_t begin_slice = 0, std::size_t end_slice = N) const
