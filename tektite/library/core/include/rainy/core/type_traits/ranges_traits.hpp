...
namespace rainy::type_traits::extras::ranges {
     ...
     *
     * \lang simp-chinese
     * @brief range_traits 的主模板，为范围属性提供统一接口。
     *
     * @tparam Range 要检查的范围类型
     */
    template <typename Range>
     ...
     *
     * \lang simp-chinese
     * @brief range_reference 的别名模板，提供对范围引用类型的直接访问。
     *
     * @tparam Range 范围类型
     */
    template <typename Range>
     ...
     *
     * \lang simp-chinese
     * @brief range_const_reference 的别名模板，提供对范围常量引用类型的直接访问。
     *
     * @tparam Range 范围类型
     */
    template <typename Range>
     ...
     *
     * \lang simp-chinese
     * @brief range_difference 的别名模板，提供对范围差类型的直接访问。
     *
     * @tparam Range 范围类型
     */
    template <typename Range>
     ...
     *
     * \lang simp-chinese
     * @brief range_value_type 的别名模板，提供对范围值类型的直接访问。
     *
     * @tparam Range 范围类型
     */
    template <typename Range>
