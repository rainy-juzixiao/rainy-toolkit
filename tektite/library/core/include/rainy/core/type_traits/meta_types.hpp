...
namespace rainy::type_traits::extras::meta_types {
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `value_type` 成员的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `value_type` 成员的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `size_type` 成员的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * \lang simp-chinese
     * @brief 检测是否存在 Ty::size_type 的特化。
     *
     * @tparam Ty 提供 size_type 的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `size_type` 成员的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `difference_type` 成员的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `difference_type` 成员的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `reference` 成员的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `reference` 成员的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `const_reference` 成员的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * \lang simp-chinese
     * @brief 检测是否存在 Ty::const_reference 的特化。
     *
     * @tparam Ty 提供 const_reference 的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `const_reference` 成员的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `pointer` 成员的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `pointer` 成员的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `const_pointer` 成员的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * \lang simp-chinese
     * @brief 检测是否存在 Ty::const_pointer 的特化。
     *
     * @tparam Ty 提供 const_pointer 的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `const_pointer` 成员的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `iterator` 类型的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `iterator` 类型的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `const_iterator` 类型的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * @tparam Ty 提供 const_iterator 的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `const_iterator` 类型的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `reverse_iterator` 类型的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * \lang simp-chinese
     * @brief 检测是否存在 Ty::reverse_iterator 的特化。
     *
     * @tparam Ty 提供 reverse_iterator 的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `reverse_iterator` 类型的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `const_reverse_iterator` 类型的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * \lang simp-chinese
     * @brief 检测是否存在 Ty::const_reverse_iterator 的特化。
     *
     * @tparam Ty 提供 const_reverse_iterator 的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `const_reverse_iterator` 类型的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `key_type` 成员的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * \lang simp-chinese
     * @brief 检测是否存在 Ty::key_type 的特化。
     *
     * @tparam Ty 提供 key_type 的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `key_type` 成员的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `mapped_type` 成员的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `mapped_type` 成员的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `allocator_type` 成员的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * \lang simp-chinese
     * @brief 检测是否存在 Ty::allocator_type 的特化。
     *
     * @tparam Ty 提供 allocator_type 的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `allocator_type` 成员的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `char_type` 成员的变量模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty, typename = void>
     ...
     *
     * \lang simp-chinese
     * @brief 检测是否存在 Ty::char_type 的特化。
     *
     * @tparam Ty 提供 char_type 的类型
     */
    template <typename Ty>
     ...
     *
     * \lang simp-chinese
     * @brief 检查类型是否具有嵌套的 `char_type` 成员的类型模板。
     *
     * @tparam Ty 要检查的类型
     */
    template <typename Ty>
