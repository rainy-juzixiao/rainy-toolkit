...
namespace rainy::core::collections::views::implements {
    ...
    public:
        ...
        constexpr explicit invoker_view(ViewOrContainer range_,
                                        Fx func) noexcept(type_traits::properties::is_nothrow_move_constructible_v<ViewOrContainer> &&
        ...
        RAINY_NODISCARD constexpr auto begin() noexcept(
            noexcept(utility::begin(range)) &&
            type_traits::properties::is_nothrow_move_constructible_v<type_traits::extras::iterators::iterator_t<ViewOrContainer>>) {
        ...
        template <type_traits::other_trans::enable_if_t<
                      type_traits::properties::is_invocable_v<const Fx &,
                                                              type_traits::extras::ranges::range_reference_t<const ViewOrContainer>>,
                      int> = 0>
        RAINY_NODISCARD constexpr auto begin() const noexcept(
            noexcept(utility::begin(range)) &&
            type_traits::properties::is_nothrow_move_constructible_v<type_traits::extras::iterators::iterator_t<ViewOrContainer>>) {
        ...
        RAINY_NODISCARD constexpr auto end() noexcept(
            noexcept(utility::end(range)) && type_traits::properties::is_nothrow_move_constructible_v<decltype(utility::end(range))>) {
        ...
        RAINY_NODISCARD constexpr auto end() const
            noexcept(noexcept(utility::end(range)) &&
                     type_traits::properties::is_nothrow_move_constructible_v<decltype(utility::end(range))>) {
