...
#else
#define RAINY_USING_WINDOWS false
#endif

#ifdef __linux__
#define RAINY_USING_LINUX true
#else
...
#else
#define RAINY_CAN_USING_AVX2 false
#endif
...
namespace rainy::information::pal {
    ...
    // 使用std::intptr_t仅仅是为了表示size，而不是内存，它与内存无关。
}
...
namespace rainy::information::pal {
    ...
    RAINY_HPP_INLINE void deallocate(void *ptr, const std::size_t size, const std::size_t alignment);
    /* read i/o */
...
#include <rainy_cxxfiles/core/core.cxx>
#endif
