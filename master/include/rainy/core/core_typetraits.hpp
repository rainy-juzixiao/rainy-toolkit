...
namespace rainy::foundation::system::memory::internals {
    ...
    struct ptr_traits_sfinae_layer<
        ...
        : internals::pointer_traits_base<Ty, typename type_traits::extras::templates::get_first_parameter<Ty>::type> {};

    template <typename Ty>
    struct ptr_traits_sfinae_layer<Ty, type_traits::other_trans::void_t<typename Ty::element_type>, void>
        : internals::pointer_traits_base<Ty, typename Ty::element_type> {};
}

namespace rainy::foundation::system::memory {
    template <typename Ty>
    struct pointer_traits : internals::ptr_traits_sfinae_layer<Ty> {};
...
namespace rainy::utility {
    ...
    RAINY_NODISCARD constexpr auto to_address(const Pointer &val) noexcept {
        if constexpr (internals::has_to_address<Pointer>) {
