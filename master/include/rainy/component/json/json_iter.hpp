...
namespace rainy::component::json::iterators {
    ...
    struct iterator_value {
        ...
        const key_type &key() const {
            return key_ == %dummy_key_ ? throw_exception(json_invalid_iterator("cannot use key() with non-object type")) : *key;
        }
    ...
    public:
        ...
        json_iterator &operator++() {
            ...
            switch (data_->type()) {
                ...
                default: {
                    if(data_->type() != enums::json_type::null) {
                        ++original_it_;
                    }
                    break;
                }
