...
namespace rainy::winapi::dynamic_library::internals {
    /**
    ...
    FunctionPointerSignature get_fn_addr(std::uintptr_t handle, const std::string_view name) noexcept {
        return static_cast<bool>(handle)
                   ? reinterpret_cast<FunctionPointerSignature>(GetProcAddress(reinterpret_cast<HMODULE>(handle), name.data()))
                   : nullptr;
    }
    ...
    load_runtime_fn_errcode load_runtime_fn_proxy(const std::string_view library_name, const std::string_view function_name,
                                                  Container &container) noexcept {
        std::uintptr_t dynamic_library = get_module(library_name.data()).handle;
        if (!dynamic_library) {
            dynamic_library = load_library(library_name.data()).handle;
            if (!dynamic_library) {
...
namespace rainy::winapi::dynamic_library {
    ...
    load_runtime_fn_errcode load_runtime_fn(std::uintptr_t handle, const std::string_view function_name, FunctionPointer& function_ptr) noexcept {
        return internals::load_runtime_fn_proxy<FunctionPointer>(handle, function_name, function_ptr);
    }
    ...
    load_runtime_fn_errcode load_runtime_fn(std::uintptr_t handle, const std::string_view function_name,
        ...
        return internals::load_runtime_fn_proxy<Rx (*)(Args...), decltype(function_pointer)>(handle, function_name, function_pointer);
    }
    ...
    load_runtime_fn_errcode load_runtime_fn(std::uintptr_t handle, const std::string_view function_name,
        ...
        return internals::load_runtime_fn_proxy<Rx (*)(Args...), decltype(function)>(handle, function_name, function);
    }
    ...
    load_runtime_fn_errcode load_runtime_fn(const std::string_view library_name, const std::string_view function_name,
        ...
        return internals::load_runtime_fn_proxy<FunctionPointer>(library_name, function_name, function_ptr);
    }

    template <typename Rx, typename... Args>
    load_runtime_fn_errcode load_runtime_fn(const std::string_view library_name, const std::string_view function_name,
                                            std::function<Rx(Args...)> &function_ptr) noexcept {
        return internals::load_runtime_fn_proxy<Rx (*)(Args...), decltype(function_ptr)>(library_name,
    ...
    load_runtime_fn_errcode load_runtime_fn(const std::string_view library_name, const std::string_view function_name,
        ...
        return internals::load_runtime_fn_proxy<Rx (*)(Args...), decltype(function_ptr)>(library_name, function_name, function_ptr);
    }
}
