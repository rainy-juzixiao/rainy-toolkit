...
namespace rainy::winapi::error_process {
    RAINY_DECLARE_CHARSET_TEMPLATE RAINY_NODISCARD std::basic_string<CharType> last_error_message(DWORD error_code = 0) {
        if (error_code == 0) {
...
namespace rainy::winapi::dynamic_libray {
    RAINY_DECLARE_CHARSET_TEMPLATE HMODULE get_module_handle(const CharType *module_name = nullptr) {
...
namespace rainy::foundation::system::dynamic_libray {
