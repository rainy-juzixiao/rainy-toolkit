...
namespace rainy::winapi::system::multithread::internals {
     ...
     */
    RAINY_TOOLKIT_API RAINY_INLINE PSRWLOCK get_srw_lock(mtx_t *mtx) noexcept;
     ...
     */
    RAINY_TOOLKIT_API RAINY_INLINE win32_thread_result mtx_do_lock(mtx_t *mtx, const ::timespec *target) noexcept;
}
...
namespace rainy::winapi::system::multithread {
     ...
     */
    RAINY_TOOLKIT_API RAINY_INLINE win32_thread_result mtx_init(mtx_t *mtx, int flags) noexcept;
     ...
     */
    RAINY_TOOLKIT_API RAINY_INLINE win32_thread_result mtx_create(mtx_t *mtx, int flags) noexcept;
     ...
     * @return 一般返回success来表示成功。但是，如果mtx为空，errno将被设置为EINVAL，并返回nomem
     */
    RAINY_TOOLKIT_API RAINY_INLINE win32_thread_result mtx_lock(mtx_t *mtx) noexcept;
     ...
     */
    RAINY_TOOLKIT_API RAINY_INLINE win32_thread_result mtx_trylock(mtx_t *mtx) noexcept;
     ...
     * @return 一般返回success来表示成功。但是，如果mtx为空，errno将被设置为EINVAL，并返回nomem
     */
    RAINY_TOOLKIT_API RAINY_INLINE win32_thread_result mtx_unlock(mtx_t *mtx) noexcept;
     ...
     */
    RAINY_TOOLKIT_API RAINY_INLINE win32_thread_result mtx_timedlock(mtx_t *mtx, const ::timespec *xt) noexcept;
     ...
     */
    RAINY_TOOLKIT_API RAINY_INLINE bool mtx_current_owns(mtx_t *mtx) noexcept;
     ...
     */
    RAINY_TOOLKIT_API RAINY_INLINE win32_thread_result mtx_destroy(mtx_t *mtx, bool release = true) noexcept;
}
