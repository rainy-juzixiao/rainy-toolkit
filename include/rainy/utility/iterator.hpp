...
namespace rainy::utility::internals {
    ...
    template <typename Ty, bool Enable = type_traits::extras::meta_typedef::has_element_type_v<Ty>>
...
namespace rainy::utility {
    ...
    public:
        ...
        constexpr const_iterator(const_iterator &&right) noexcept : range_base_(right.range_base_), current(utility::exchange(right.current, {})) {
        }
...
namespace rainy::utility {
    ...
    public:
        ...
        RAINY_NODISCARD ostream_iterator &operator*() noexcept {
            return *this;
        }
