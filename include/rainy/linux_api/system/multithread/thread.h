...
namespace rainy::linux_api::system::multithread {
    ...
    */
    RAINY_TOOLKIT_API std::uintptr_t create_thread(
   ...
   /**
     ...
     */
    RAINY_TOOLKIT_API RAINY_NODISCARD std::uintptr_t create_thread(
     ...
     */
    RAINY_TOOLKIT_API posix_thread_result thread_join(std::uintptr_t thread_handle,
     ...
     */
    RAINY_TOOLKIT_API posix_thread_result thread_detach(std::uintptr_t thread_handle) noexcept;
