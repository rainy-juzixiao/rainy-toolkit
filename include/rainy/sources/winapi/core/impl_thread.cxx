...
namespace rainy::foundation::system::async::internals {
...
#else
                io::print::stderr_println("You must invoke join() method to close this thread.");
                std::terminate();
#endif
            }
        }
...
#else
                io::print::stderr_println("The syttem resources is unavailable.");
                std::terminate();
#endif
            }
...
#else
                io::print::stderr_println("Need joinable() result is true.");
                std::terminate();
#endif
            }
...
#else
                io::print::stderr_println("Failed to join the thread.");
                std::terminate();
#endif
            }
            thrd = {};
...
#else
                io::print::stderr_println("Failed to detach the thread.");
                std::terminate();
#endif
            }
            thrd = {};
    ...
    void uninit_async_moudle_abi() {
        comint::remove_interface<native_thread>();
    }
}