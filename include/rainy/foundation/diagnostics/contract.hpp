...
namespace rainy::foundation::diagnostics::internals {
    ...
    using contract_handler_type =
        functional::function_pointer<void(std::string_view, unique_error_code, const utility::source_location &)>;
}
...
namespace rainy::foundation::diagnostics {
    ...
    public:
        using handler_type = internals::contract_handler_type;
...
#endif
        internals::call_contract(cond, type, message, error_code, options, location);
    }
