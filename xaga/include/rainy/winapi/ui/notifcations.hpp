...
namespace rainy::winapi::ui::notifcations::implements {
...
namespace rainy::winapi::ui::notifcations {
    class notifcation_handler {
        enum class dismissal_reason {
            user_canceled = implements::abi_toast_dismissal_reason::UserCanceled,
            application_hidden = implements::abi_toast_dismissal_reason::ApplicationHidden,
            timed_out = implements::abi_toast_dismissal_reason::TimedOut
        };
...
namespace rainy::winapi::ui::notifcations {
    enum class notifaction_template_type {
        image_and_text01 = implements::abi_template_type::ToastImageAndText01,
        image_and_text02 = implements::abi_template_type::ToastImageAndText02,
        image_and_text03 = implements::abi_template_type::ToastImageAndText03,
        image_and_text04 = implements::abi_template_type::ToastImageAndText04,
        text01 = implements::abi_template_type::ToastText01,
        text02 = implements::abi_template_type::ToastText02,
        text03 = implements::abi_template_type::ToastText03,
        text04 = implements::abi_template_type::ToastText04
    };
}
