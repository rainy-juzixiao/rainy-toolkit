...
namespace rainy::foundation::reflection {
    ...
    private:
        ...
        struct accessor {
            virtual rainy::utility::any getter(const void *) = 0;
            virtual void setter(void *, const rainy::utility::any &) = 0;
        ...
        struct accessor_impl : public accessor {
            ...
            virtual rainy::utility::any getter(const void *obj) override {
                if constexpr (std::is_same_v<Class, void>) {
                    return rainy::utility::any(*pointer);
                } else {
                    return rainy::utility::any(static_cast<const Class *>(obj)->*pointer);
                }
            }

            virtual void setter(void *obj, const rainy::utility::any &value) override {
                if (sti_typeid(Ty) != value.type() || !value.has_value()) {
