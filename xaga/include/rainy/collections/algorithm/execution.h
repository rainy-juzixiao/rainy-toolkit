...
namespace rainy::collections::algorithm::execution {
    enum policy {
        par,
        seq,
        max_par
...
namespace rainy::collections::algorithm::implements {
    RAINY_INLINE std::size_t get_paralells(const std::size_t count) {
        std::size_t paralells = 1;
        collections::array<std::pair<std::size_t, std::size_t>, 4> thresholds = {{{75, 100}, {100, 250}, {300, 648}, {800, 1500}}};
        collections::array<std::size_t, 4> increments = {1, 2, 3, 4};
