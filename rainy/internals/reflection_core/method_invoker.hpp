...
#define RAINY_CONST_METHOD_INVOKER(CLASSNAME, QUAL)                                                                                   \
    ...
    struct CLASSNAME {                                                                                                                \
        ...
        any invoke(void *obj, const std::vector<containers::any> &params) const {                                                     \
...
namespace rainy::foundation::reflection::internals {
    ...
    template <typename Class, typename ReturnType, typename... Args>
    containers::any call_cmethod(const union_method_container<Class, ReturnType, Args...> &storage, method_type type, void *object,
                                 const std::vector<containers::any> &params) {
        switch (type) {
    ...
    template <typename Class, typename ReturnType, typename... Args>
    containers::any call_cmethod_left(const union_method_container<Class, ReturnType, Args...> &storage, method_type type,
                                      void *object, const std::vector<containers::any> &params) {
        switch (type) {
    ...
    template <typename Class, typename ReturnType, typename... Args>
    containers::any call_cmethod_right(const union_method_container<Class, ReturnType, Args...> &storage, method_type type,
                                       void *object, const std::vector<containers::any> &params) {
        switch (type) {
            case method_type::const_method_left:
                return storage.const_method_left.invoke(object, params);
    ...
    template <typename Class, typename ReturnType, typename... Args>
    containers::any call_normal_method(const union_method_container<Class, ReturnType, Args...> &storage, method_type type,
                                       void *object, const std::vector<containers::any> &params) {
        switch (type) {
    ...
    template <typename Class, typename ReturnType, typename... Args>
    containers::any call_normal_method_left(const union_method_container<Class, ReturnType, Args...> &storage, method_type type,
                                            void *object, const std::vector<containers::any> &params) {
        switch (type) {
    ...
    template <typename Class, typename ReturnType, typename... Args>
    containers::any call_normal_method_right(const union_method_container<Class, ReturnType, Args...> &storage, method_type type,
                                             void *object, const std::vector<containers::any> &params) {
        switch (type) {
